...
class _CricketScreenState extends ConsumerState<CricketScreen> {
  ...
  String _leagueLabel(String name) {
    ...
    if (n.contains('big bash') || n.contains('bbl')) return 'BBL';
    if (n.contains('caribbean premier') || n.contains('cpl')) return 'CPL';
    if (n.contains('t20 world cup')) return 'T20 WC';
    if (n.contains('world cup')) return 'World Cup';
    if (n.contains('test')) return 'Test';
    if (n.contains('odi')) return 'ODI';
    String label = name;
      ...
      body: matchesAsync.when(
        ...
        loading: () => const Center(
          child: CircularProgressIndicator(
              color: AppColors.cricket, strokeWidth: 2.5),
        ),
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: AppColors.cricket.withValues(alpha: 0.30),
                blurRadius: 16,
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              padding: const EdgeInsets.symmetric(horizontal: 16),
              decoration: BoxDecoration(
                color: selected ? AppColors.cricket : Colors.white,
                borderRadius: BorderRadius.circular(18),
                border: Border.all(
                  color: selected ? AppColors.cricket : AppColors.border,
                  width: 1.2,
                ),
                boxShadow: selected
                    ? [
                        BoxShadow(
                          color: AppColors.cricket.withValues(alpha: 0.22),
                          blurRadius: 8,
                          offset: const Offset(0, 3),
                        )
                      ]
          ...
          children: [
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: AppColors.cricket,
