...
class _CricketScreenState extends ConsumerState<CricketScreen> {
  ...
  Map<String, dynamic> _getTournamentMetadata(String name) {
    ...
    if (lowerName.contains('world cup') || lowerName.contains('t20')) {
      return {'label': 'World Cup', 'icon': Icons.public_rounded};
    }
    String label = name;
            ...
            child: CustomScrollView(
              ...
              slivers: [
                ...
                if (allMatches.isEmpty)
                  SliverFillRemaining(child: _buildEmptyState(Icons.sports_cricket_rounded, 'No cricket matches available'))
                    ...
                    sliver: SliverList(
                      delegate: SliverChildBuilderDelegate(
                        (context, index) {
                          ...
                          return _buildMatchTile(filteredMatches[dataIndex]);
                        },
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF0D3B1A), Color(0xFF1B5E35)],
        ),
        borderRadius: BorderRadius.circular(20),
        boxShadow: [
          BoxShadow(color: const Color(0xFF1B5E35).withOpacity(0.35), blurRadius: 16, offset: const Offset(0, 6)),
        ],
      ),
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                const Text('Cricket', style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.w900)),
                Text(
          ...
          return Padding(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: isSelected ? const Color(0xFF1B5E35) : Colors.white,
                  borderRadius: BorderRadius.circular(25),
                  boxShadow: [
                    if (isSelected)
                      BoxShadow(color: const Color(0xFF1B5E35).withOpacity(0.3), blurRadius: 10, offset: const Offset(0, 4))
                    else
                      BoxShadow(color: Colors.black.withOpacity(0.04), blurRadius: 4, offset: const Offset(0, 2)),
                  ],
                  border: Border.all(
                    color: isSelected ? const Color(0xFF1B5E35) : const Color(0xFFF1F3F5),
                    width: 1.5,
                  ),
                ),
                child: Center(
